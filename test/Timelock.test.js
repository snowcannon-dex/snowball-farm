...
const SnowCannon = artifacts.require("SnowCannon");
...
contract("Timelock", ([alice, bob, carol, dev, minter]) => {
  beforeEach(async () => {
    this.cake = await SnowballToken.new({ from: alice });
  ...
  it("should also work with SnowCannon", async () => {
    ...
    this.chef = await SnowCannon.new(
      this.cake.address,
      this.syrup.address,
      dev,
      "1000",
